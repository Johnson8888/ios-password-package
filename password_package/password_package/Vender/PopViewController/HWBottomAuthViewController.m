...
@property (nonatomic, copy) AuthCompletion completion;
...
- (UIButton *)confirmButton {
    if (!_confirmButton) {
        ...
        [_confirmButton setTitle:self.buttonText forState:UIControlStateNormal];
        ...
        [_confirmButton addTarget:self action:@selector(copyAction) forControlEvents:UIControlEventTouchUpInside];
    }
